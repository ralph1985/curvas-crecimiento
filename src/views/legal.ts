    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Ese almacenamiento también conserva la preferencia de tema (automático, claro u oscuro), el registro de que se ha mostrado la información inicial sobre privacidad y las fechas locales necesarias para recordar cuándo conviene preparar otra copia. Ninguno de esos datos se envía al titular.',
  ...
  'politica-cookies': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'La aplicación usa localStorage, una función del navegador distinta de las cookies, para guardar tus registros, tu preferencia de tema, las fechas locales del recordatorio de copia y recordar que ya has visto la información inicial sobre privacidad.',
