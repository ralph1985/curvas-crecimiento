...
- La URL Preview responde con el HTML de la aplicación; la comprobación interactiva de datos nuevos/importados, temas y tamaños queda pendiente porque el smoke test HTTP no sustituye una revisión visual completa.
