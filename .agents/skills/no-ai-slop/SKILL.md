...
- **Preserve useful edge and character.** Keep strong opinions, blunt language, humor, profanity, and honest admissions when they belong to the writer. Don't replace them with safer or more professional wording.
...
**Colon reveals.** Use colons for lists, labels, and quotes, not fake drama. Prefer sentence case after a colon unless grammar, a proper noun, a title, or code requires otherwise.

**Superficial analysis.** Cut trailing -ing clauses that pretend to explain meaning. Replace them with the concrete action or consequence.

**Importance puffery.** State the fact and let the reader judge whether it matters.

**Interpretive metadiscourse.** Cut lines that tell the reader what to notice or how to interpret the prose when the surrounding facts already show it.

**Weasel attribution.** Name the source or cut the claim. If the user has no source, ask instead of inventing one.

**Fake-strong verbs.** Prefer clear verbs such as "is", "has", "tracks", and "can" over inflated phrases.

**Synonym cycling.** Repeat the clear word when it is right.

**Negative listing.** State the positive description directly.

**Dramatic fragmentation.** Use complete sentences unless a fragment clearly belongs to the writer's voice.

**Robotic rhythm.** Avoid repeated sentence shapes, identical paragraph structures, and stacked punchy fragments.

**Rhetorical setups.** Drop "What if I told you...", "Think about it:", "Plot twist:", and self-answered question pairs.

**Fake-profound kickers.** End on the clearest concrete point. Do not turn it into a metaphor or mic-drop line.

**Summary-recap endings.** End on the last concrete point, takeaway, or next action.

**Formatting slop.** Avoid emoji headings, decorative bold, bullets where prose would read better, and headers over tiny sections.
